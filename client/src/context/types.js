...
export const DEL_ONE_NOTIFICATION = "DEL_ONE_NOTIFICATION";
export const MARK_ALL_NOTIFICATIONS = "MARK_ALL_NOTIFICATIONS";
export const MARK_ONE_NOTIFICATION = "MARK_ONE_NOTIFICATION";
export const SET_NTFS = "SET_NTFS";
export const SET_OTHER_USER_MESSAGE_SEEN = "SET_OTHER_USER_MESSAGE_SEEN";
